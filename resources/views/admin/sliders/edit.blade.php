...
@section('content')
  <div class="content-wrapper">
      ...
      <form class="needs-validation" action="{{ route('sliders.update',['id' => $slider->id]) }}" method="POST" enctype="multipart/form-data">
        <div class="content">
              ...
              <div class="col-md-4">
                  @csrf
                    ...
                    <div class="form-group">
                        ...
                        name="image_path">
                        <img style="width: 250px; height: auto; object-fit: cover; margin-top: 20px" src="{{ $slider->image_path }}" alt="">
                        @error('image_path')
                          <div class="text-sm" style="color: red">{{ $message }}</div>
                        @enderror
                    </div>
